...
_1586: () => globalThis.rightInset(),
_1587: () => globalThis.rightInset(),
_1588: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1589: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
...
_1738: (x0,x1) => x0.cancel(x1),
_1739: x0 => x0.read(),
_1742: x0 => x0.value,
_1744: x0 => x0.done,
_1747: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11) => ({method: x0,headers: x1,body: x2,mode: x3,credentials: x4,cache: x5,redirect: x6,referrer: x7,referrerPolicy: x8,integrity: x9,keepalive: x10,signal: x11}),
_1749: (x0,x1) => x0.method = x1,
_1762: (x0,x1) => x0.redirect = x1,
_1775: (x0,x1) => globalThis.fetch(x0,x1),
_1776: () => new AbortController(),
_1777: x0 => x0.abort(),
_1778: (x0,x1) => x0.get(x1),
_1779: (x0,x1) => x0.get(x1),
_1780: (x0,x1) => x0.get(x1),
_1804: x0 => new Headers(x0),
_1807: x0 => x0.entries(),
_1826: x0 => x0.body,
_1828: x0 => x0.headers,
_1830: x0 => x0.redirected,
_1831: x0 => x0.status,
_1832: x0 => x0.statusText,
_1833: x0 => x0.type,
_1834: x0 => x0.url,
_1877: x0 => x0.signal,
_1891: (x0,x1) => x0.key(x1),
_1892: (a, i) => a.push(i),
_1896: a => a.pop(),
_1897: (a, i) => a.splice(i, 1),
_1899: (a, s) => a.join(s),
_1900: (a, s, e) => a.slice(s, e),
_1902: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
_1903: a => a.length,
_1905: (a, i) => a[i],
_1906: (a, i, v) => a[i] = v,
_1908: a => a.join(''),
_1909: (o, a, b) => o.replace(a, b),
_1911: (s, t) => s.split(t),
_1912: s => s.toLowerCase(),
_1913: s => s.toUpperCase(),
_1914: s => s.trim(),
_1915: s => s.trimLeft(),
_1916: s => s.trimRight(),
_1918: (s, p, i) => s.indexOf(p, i),
...
_1921: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_1922: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_1923: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1924: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
_1925: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_1926: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_1927: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_1929: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_1930: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
_1931: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_1932: Object.is,
_1933: (t, s) => t.set(s),
...
_1962: (x0,x1) => x0.getRandomValues(x1),
_1963: x0 => new Uint8Array(x0),
_1964: () => globalThis.crypto,
_1967: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1968: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1970: (s, m) => {
          try {
...
_1981: o => o === undefined,
_1982: o => typeof o === 'boolean',
_1983: o => typeof o === 'number',
_1985: o => typeof o === 'string',
_1988: o => o instanceof Int8Array,
_1989: o => o instanceof Uint8Array,
_1990: o => o instanceof Uint8ClampedArray,
_1991: o => o instanceof Int16Array,
_1992: o => o instanceof Uint16Array,
_1993: o => o instanceof Int32Array,
_1994: o => o instanceof Uint32Array,
_1995: o => o instanceof Float32Array,
_1996: o => o instanceof Float64Array,
_1997: o => o instanceof ArrayBuffer,
_1998: o => o instanceof DataView,
_1999: o => o instanceof Array,
...
_2024: l => arrayFromDartList(Array, l),
_2025: stringFromDartString,
_2026: stringToDartString,
_2027: () => ({}),
_2028: () => [],
_2029: l => new Array(l),
_2030: () => globalThis,
_2031: (constructor, args) => {
...
_2033: (o, p) => o[p],
_2034: (o, p, v) => o[p] = v,
_2035: (o, m, a) => o[m].apply(o, a),
_2037: o => String(o),
_2038: (p, s, f) => p.then(s, f),
_2039: s => {
...
_2050: x0 => x0.flags,
_2051: x0 => x0.multiline,
_2052: x0 => x0.ignoreCase,
_2053: x0 => x0.unicode,
_2054: x0 => x0.dotAll,
_2055: (x0,x1) => x0.lastIndex = x1,
_2057: (o, p) => o[p],
_2063: (x0,x1) => x0.bind(x1),
_2066: x0 => x0.next,
_2073: (x0,x1) => x0.call(x1),
_2074: (x0,x1,x2) => x0.call(x1,x2),
_2084: x0 => x0.done,
_2086: x0 => x0.value,
_2125: x0 => x0.status,
_2127: (x0,x1) => x0.responseType = x1,
_2129: x0 => x0.response,
_3886: () => globalThis.window,
_4225: x0 => x0.localStorage,
_4666: x0 => x0.length,
_14733: () => globalThis.window,
_14754: x0 => x0.matches,
_14758: x0 => x0.platform,
_14763: x0 => x0.navigator,
_14777: () => globalThis.window.flutterCanvasKit
    };
